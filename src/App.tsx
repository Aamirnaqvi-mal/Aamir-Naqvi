  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <ChevronDown className="w-5 h-5 text-[#8A1212]" strokeWidth={1.5} />
          </div>
          <span className="text-[#181F21] text-[30px] uppercase tracking-[0.25em] font-light ibm-font">Scroll Down</span>
        </div>
      </div>
